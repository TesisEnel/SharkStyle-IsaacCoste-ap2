...
import com.example.sharkstyle.presentation.carrito.CarritoViewModel
    ...
    ProductoBodyScreen(
        ...
        onAddToCart = { event ->
            coroutineScope.launch {
                carritoViewModel.onEvent(event)
            }
        }
...
//                            Text(text = size, color = Color.Black)
                ...
                Row(
                    ...
                    Button(
                        onClick = { /* Acción al hacer clic en comprar */ },
                    ...
                    Box(
                        ...
                        modifier = Modifier
                            .size(40.dp)
                            .background(Color(0xFF000000), shape = RoundedCornerShape(12.dp))
                            .clickable {
                                val carritoDetalle = DetalleCarritoEntity(
                                    carritoId = 0,
                                    productoId = uiState.productoId ?: 0,
                                    cantidad = 1,
                                    precio = uiState.precio ?: 0.0
                                )
                                onAddToCart(CarritoUiEvent.AgregarProducto(carritoDetalle, 1 ))
                            }
                    ) {
                        Image(
